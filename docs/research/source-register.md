...
| Candidate binary | <https://micropython.org/resources/firmware/ESP32_GENERIC_S3-SPIRAM_OCT-20260406-v1.28.0.bin> | HTTP 200; 1,758,064 bytes; repository-research SHA-256 `67c19ae123d84152019b57526ed5291dd0a2b4edd87655c5f76b46c9a62ff5dd`. Re-verify when downloading. |
...
| RP326 facts | Purchased unit self-test and Rongta material (pending collection) | Endpoint, firmware, exact cutter sequence, and physical status behavior remain unverified. |

The official RP326 material was not sufficiently accessible during initialization
to promote marketing values into verified facts. Record the purchased self-test
and first-party manual/configuration utility details before updating claims.
