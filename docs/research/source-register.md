...
| Epson ESC/POS raster command | <https://download4.epson.biz/sec_pubs/pos/reference_en/escpos/gs_lv_0.html> | `GS v 0` carries mode, horizontal byte count, vertical dot count, and raster bytes; a one bit prints black. It is documented but not physically verified on the purchased RP326. |
